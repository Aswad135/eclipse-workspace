...
public class Address {
	...
	public boolean validateAddress() {
		if (this.getStreet2().equals("")) 
			return this.validateCity() && this.validateState() && this.validateZip() && this.validateStreet1();

		else
			return this.validateState() && this.validateZip() && this.validateCity() && this.validateStreet1() && this.validateStreet2();
	}
	...
	public boolean validateMailingAddress() {
		return (this.validateCity() && this.validateState() && this.validateZip());
	}
